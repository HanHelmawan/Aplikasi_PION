      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
                  ...
                  Container(
                    ...
                    child: const Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 4),
                        Text('Top', style: TextStyle( color: Color(0xFF2563EB), fontSize: 10, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
              ],
            ...
            Text(specialty, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle( fontSize: 13, color: Color(0xFF64748B))),
            const SizedBox(height: 10),
            ...
            Row(
              ...
              children: [
                ...
                Row(children: [
                  ...
                  const SizedBox(width: 4),
                  Text('$jobs tugas', maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle( fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF64748B))),
                ]),
              ],
            ),
          ],
